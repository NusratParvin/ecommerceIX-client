...
//       : { growthDescription: "+0% from last month" };
...
//   // Color logic for descriptions
//   const getGrowthColor = (growthDescription: string) => {
//     if (growthDescription.includes("+")) return "text-green-600";
//     if (growthDescription.includes("-")) return "text-red-600";
...
//       description: growthData.growthDescription,
//       descriptionClassName: getGrowthColor(growthData.growthDescription),
//     },
//     {
//       title: "Total Orders",
