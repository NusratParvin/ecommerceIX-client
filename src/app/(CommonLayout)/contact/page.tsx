...
//                 <span className="mb-4 block text-base font-semibold text-charcoal">
//                   Contact Us
//                 </span>
//                 <h2 className="mb-6 text-[32px] font-bold uppercase text-deep-brown dark:text-white sm:text-[40px] lg:text-[36px] xl:text-[40px]">
//                   GET IN TOUCH WITH US
//                 </h2>
//                 <p className="mb-9 text-base leading-relaxed text-body-color dark:text-deep-brown-6">
...
//                     <h4 className="mb-1 text-xl font-bold text-deep-brown dark:text-white">
//                       Our Location
//                     </h4>
//                     <p className="text-base text-body-color dark:text-deep-brown-6">
