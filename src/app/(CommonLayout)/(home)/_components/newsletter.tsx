...
const NewsletterSection = () => {
  ...
  return (
    <div
      className="my-10 pb-8 mx-auto  flex flex-col justify-center items-center rounded-none px-4 sm:px-10 border bg-cover bg-center bg-no-repeat h-64 w-11/12"
      style={{ backgroundImage: "url('/assets/slider3.png')" }}
    >
      {/* Overlay for dimming if needed */}
      <div className="w-full h-full bg-black/20 flex flex-col justify-center items-center">
        {/* Content Section */}
        ...
        <div className="md:w-1/2 w-full mx-auto mt-8">
          <div className="flex flex-row items-center rounded-md border bg-white/80">
            <Input
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="h-10 w-full max-w-sm rounded-none border-none border-b-2 border-deep-brown px-4 text-gray-500"
              placeholder="Enter your email"
              type="email"
              name="email"
            />
