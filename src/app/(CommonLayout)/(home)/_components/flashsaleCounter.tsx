...
export default function FlashsaleCounter() {
  return (
    <section className="bg-gray-900/80 bg-gradient h-auto md:h-12 flex items-center mb-8 py-2 md:py-0">
      <div className="px-6 lg:px-16 mx-auto w-full ">
        <div className="flex flex-col md:flex-row items-center justify-between gap-2 w-full">
          ...
          <div className="flex justify-center md:justify-end w-full md:w-auto">
            <CountdownTimer endDate={new Date(2026, 12, 30, 10, 0, 0)} />
          </div>
        </div>
      </div>
    </section>
