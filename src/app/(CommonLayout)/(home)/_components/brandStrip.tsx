  ...
  return (
    <section className="w-full bg-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* container */}
        <div className="flex md:flex-row  flex-wrap  items-center justify-between gap-8 py-10 md:py-14">
          {logos.map((logo) => (
            <div
              key={logo.alt}
              className="relative h-10 w-24 sm:h-12 sm:w-32 md:h-14 md:w-40 lg:h-16 lg:w-44
