    ...
    <>
      ...
      <div className="w-full md:w-10/12 mx-auto p-4 text-center mt-24 text-sm text text-slate-600 min-h-screen">
        ...
        <Link href="/">
          <Button
            type="submit"
            className="relative w-3/4 sm:w-1/2 md:w-1/4 mt-12 rounded-none border border-slate-600 bg-white hover:bg-white text-slate-600 overflow-hidden group py-5"
          >
            {/* Animated Background */}
            ...
            {/* Button Text */}
            <span className="relative z-10 group-hover:text-white font-semibold md:text-base text-sm uppercase">
              Return to Home
            </span>
          </Button>
        </Link>
