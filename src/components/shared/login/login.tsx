...
//             {/* Error Message */}
//             <div
//               className={`text-xs   text-red-600 mt-1 min-h-[20px] ${
...
//           </button>
//         </DialogClose>
//         <div className="flex justify-center text-sm text-charcoal/70">
//           New customer?
//           <span className="hover:underline ps-2 text-warm-brown">
