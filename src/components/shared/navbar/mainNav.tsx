...
// export function MainNav({ isScrolled }) {
//   return (
//     // <NavigationMenu>
//     //   <NavigationMenuList>
//     //     <NavigationMenuItem>
...
//         <NavigationMenuItem>
//           <Link href="/" legacyBehavior passHref>
//             <NavigationMenuLink className="text-cream hover:underline  transition-colors duration-200">
//               HOME
//             </NavigationMenuLink>
//           </Link>
//         </NavigationMenuItem>
//         <NavigationMenuItem>
//           <NavigationMenuTrigger className="text-cream  text-lg transition-colors duration-200 bg-transparent">
//             SHOP
//           </NavigationMenuTrigger>
...
//         <NavigationMenuItem>
//           <Link href="/blog" legacyBehavior passHref>
//             <NavigationMenuLink className="text-cream text-lg  transition-colors duration-200">
//               BLOG
//             </NavigationMenuLink>
//           </Link>
//         </NavigationMenuItem>
